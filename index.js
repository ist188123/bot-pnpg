...
// fim funcao
function info(informacao){
	
	var vinformacao=informacao.split("!")
	
	
   const embed = new Discord.RichEmbed()
  .setTitle(msg.guild.channels.find("name", msg.channel.name))
  .setAuthor("dad", "https://exraidspinhalnovo.webnode.pt/_files/200000024-8e37d8f30a/450/Item_1403-2.png")
  /*
   * Alternatively, use "#00AE86", [0, 174, 134] or an integer number.
   */
  .setColor(0x00AE86)
